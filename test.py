...
##  path
parser.add_argument('--data_root', type=str, default='/data/ccm/Projects/LOCATE_shiyan/dataset/AGD20K/')
# parser.add_argument('--model_file', type=str, default='/data/ccm/Projects/LOCATE/save_models/20240113_211745/best_model_5_1.192_0.407_1.265.pth')
parser.add_argument('--model_file', type=str, default='/data/ccm/Projects/LOCATE_shiyan/save_models/20230903_114106/best_model_4_1.252_0.398_1.139.pth')
parser.add_argument('--save_path', type=str, default='./save_preds_tiao_seen_125203981139')
...
if __name__ == '__main__':
    ...
    avg_inference_time = total_inference_time / len(TestLoader.dataset)
